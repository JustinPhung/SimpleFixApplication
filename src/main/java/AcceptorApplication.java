...
public class AcceptorApplication
        extends quickfix.MessageCracker implements quickfix.Application {
    ...
    public AcceptorApplication( SessionSettings settings) throws ConfigError, FieldConvertError {
